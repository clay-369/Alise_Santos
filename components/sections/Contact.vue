<template>
  <section class="flex flex-col lg:flex-row gap-10 items-center" id="contact">
    ...
    <div class="flex flex-col lg:flex-row gap-4 w-full">
      <div
        :class="`card card-border bg-base-200 hover:shadow-lg w-full transition delay-150 duration-300 ease-in-out hover:-translate-y-1 hover:scale-101 hover:cursor-pointer ${contact.color}`"
